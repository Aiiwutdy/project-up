...
def show_data_system():
    ...
    wb.open(r'D:\Python for Project\word_in_system.pdf')
...
buttonword = Button(DataEntryFrame, text='คำศัพท์ในระบบ', font=('Angsana New', 18, 'italic bold'), command=lambda:show_data_system())
...
def lmd_image(temp2):
    ...
    img = [['จาน', r"D:\Python for Project\GIF\จาน.gif"],['ส้อม', r"D:\Python for Project\GIF\ส้อม.gif"],
           ...
           ['มีด', r"D:\Python for Project\GIF\มีด.gif"], ['โรงเรียน', r"D:\Python for Project\GIF\โรงเรียน.gif"],
           ['ปากกา', r"D:\Python for Project\GIF\ปากกา.gif"], ['ฉัน', r"D:\Python for Project\GIF\ฉัน3.gif"],
           ['โต๊ะ', r"D:\Python for Project\GIF\โต๊ะ.gif"]]
